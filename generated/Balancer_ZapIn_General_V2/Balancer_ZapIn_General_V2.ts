...
export class Balancer_ZapIn_General_V2 extends ethereum.SmartContract {
  static bind(address: Address): Balancer_ZapIn_General_V2 {
    return new Balancer_ZapIn_General_V2("Balancer_ZapIn_General_V2", address);
  }
