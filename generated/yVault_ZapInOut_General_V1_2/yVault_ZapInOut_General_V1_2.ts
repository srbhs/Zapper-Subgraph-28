...
export class yVault_ZapInOut_General_V1_2 extends ethereum.SmartContract {
  static bind(address: Address): yVault_ZapInOut_General_V1_2 {
    return new yVault_ZapInOut_General_V1_2(
