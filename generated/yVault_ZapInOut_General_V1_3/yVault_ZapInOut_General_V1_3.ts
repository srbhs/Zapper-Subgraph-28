...
export class yVault_ZapInOut_General_V1_3 extends ethereum.SmartContract {
  static bind(address: Address): yVault_ZapInOut_General_V1_3 {
    return new yVault_ZapInOut_General_V1_3(
      "yVault_ZapInOut_General_V1_3",
      address
    );
  }
