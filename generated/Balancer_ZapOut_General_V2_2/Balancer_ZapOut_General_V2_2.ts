...
export class Balancer_ZapOut_General_V2_2 extends ethereum.SmartContract {
  static bind(address: Address): Balancer_ZapOut_General_V2_2 {
    return new Balancer_ZapOut_General_V2_2(
      "Balancer_ZapOut_General_V2_2",
      address
    );
  }
