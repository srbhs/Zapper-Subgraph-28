...
export class UniswapV2_ZapIn extends ethereum.SmartContract {
  static bind(address: Address): UniswapV2_ZapIn {
    return new UniswapV2_ZapIn("UniswapV2_ZapIn", address);
  }
