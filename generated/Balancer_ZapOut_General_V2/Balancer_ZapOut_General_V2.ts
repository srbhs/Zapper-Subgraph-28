...
export class Balancer_ZapOut_General_V2 extends ethereum.SmartContract {
  static bind(address: Address): Balancer_ZapOut_General_V2 {
    return new Balancer_ZapOut_General_V2(
      "Balancer_ZapOut_General_V2",
      address
    );
  }
