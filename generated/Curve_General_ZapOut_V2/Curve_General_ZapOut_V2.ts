...
export class Curve_General_ZapOut_V2___getIntermediateTokenResult {
  value0: boolean;
  value1: BigInt;
...
export class Curve_General_ZapOut_V2 extends ethereum.SmartContract {
  static bind(address: Address): Curve_General_ZapOut_V2 {
    return new Curve_General_ZapOut_V2("Curve_General_ZapOut_V2", address);
  }
  ...
  _getIntermediateToken(
    ...
    _curveExchangeAddress: Address,
    _tokenCount: BigInt
  ): Curve_General_ZapOut_V2___getIntermediateTokenResult {
    let result = super.call(
      "_getIntermediateToken",
    ...
    return new Curve_General_ZapOut_V2___getIntermediateTokenResult(
      result[0].toBoolean(),
      result[1].toBigInt()
    );
  }
  ...
  try__getIntermediateToken(
    ...
    _curveExchangeAddress: Address,
    _tokenCount: BigInt
  ): ethereum.CallResult<Curve_General_ZapOut_V2___getIntermediateTokenResult> {
    let result = super.tryCall(
      "_getIntermediateToken",
      "_getIntermediateToken(address,address,uint256):(bool,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new Curve_General_ZapOut_V2___getIntermediateTokenResult(
        value[0].toBoolean(),
        value[1].toBigInt()
      )
    );
...
export class Token2EthCall extends ethereum.Call {
  get inputs(): Token2EthCall__Inputs {
    return new Token2EthCall__Inputs(this);
  }

  get outputs(): Token2EthCall__Outputs {
    return new Token2EthCall__Outputs(this);
  }
}

export class Token2EthCall__Inputs {
  _call: Token2EthCall;

  constructor(call: Token2EthCall) {
    this._call = call;
  }
...
export class Token2EthCall__Outputs {
  _call: Token2EthCall;
...
export class Token2TokenCall extends ethereum.Call {
  get inputs(): Token2TokenCall__Inputs {
    return new Token2TokenCall__Inputs(this);
  }

  get outputs(): Token2TokenCall__Outputs {
    return new Token2TokenCall__Outputs(this);
  }
}

export class Token2TokenCall__Inputs {
  _call: Token2TokenCall;

  constructor(call: Token2TokenCall) {
    this._call = call;
  }
...
export class Token2TokenCall__Outputs {
  _call: Token2TokenCall;
...
export class SetnewsUSDTokenAddressCall extends ethereum.Call {
  get inputs(): SetnewsUSDTokenAddressCall__Inputs {
    return new SetnewsUSDTokenAddressCall__Inputs(this);
  }

  get outputs(): SetnewsUSDTokenAddressCall__Outputs {
    return new SetnewsUSDTokenAddressCall__Outputs(this);
  }
}

export class SetnewsUSDTokenAddressCall__Inputs {
  _call: SetnewsUSDTokenAddressCall;

  constructor(call: SetnewsUSDTokenAddressCall) {
    this._call = call;
  }
...
export class SetnewsUSDTokenAddressCall__Outputs {
  _call: SetnewsUSDTokenAddressCall;
