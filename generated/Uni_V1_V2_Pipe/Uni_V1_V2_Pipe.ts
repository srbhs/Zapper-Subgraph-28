...
export class Uni_V1_V2_Pipe extends ethereum.SmartContract {
  static bind(address: Address): Uni_V1_V2_Pipe {
    return new Uni_V1_V2_Pipe("Uni_V1_V2_Pipe", address);
  }
...
export class V1toV2PipeCall extends ethereum.Call {
  get inputs(): V1toV2PipeCall__Inputs {
    return new V1toV2PipeCall__Inputs(this);
  }

  get outputs(): V1toV2PipeCall__Outputs {
    return new V1toV2PipeCall__Outputs(this);
  }
}

export class V1toV2PipeCall__Inputs {
  _call: V1toV2PipeCall;

  constructor(call: V1toV2PipeCall) {
    this._call = call;
  }
...
export class V1toV2PipeCall__Outputs {
  _call: V1toV2PipeCall;
