...
export class Balancer_Unzap_V1_1 extends ethereum.SmartContract {
  static bind(address: Address): Balancer_Unzap_V1_1 {
    return new Balancer_Unzap_V1_1("Balancer_Unzap_V1_1", address);
  }
