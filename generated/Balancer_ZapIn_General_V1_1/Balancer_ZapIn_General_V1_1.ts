...
export class Balancer_ZapIn_General_V1_1 extends ethereum.SmartContract {
  static bind(address: Address): Balancer_ZapIn_General_V1_1 {
    return new Balancer_ZapIn_General_V1_1(
      "Balancer_ZapIn_General_V1_1",
      address
    );
  }
