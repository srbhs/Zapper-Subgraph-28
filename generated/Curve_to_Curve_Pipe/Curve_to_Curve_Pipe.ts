...
export class Curve_to_Curve_Pipe extends ethereum.SmartContract {
  static bind(address: Address): Curve_to_Curve_Pipe {
    return new Curve_to_Curve_Pipe("Curve_to_Curve_Pipe", address);
  }
